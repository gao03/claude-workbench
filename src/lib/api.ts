...
export const api = {
  ...
  async createCheckpoint(
    ...
    try {
      return await invoke<CheckpointResult>("create_checkpoint", {
        sessionId,
        projectId,
        projectPath,
        messageIndex,
  ...
  async restoreCheckpoint(
    ...
    try {
      return await invoke<CheckpointResult>("restore_checkpoint", {
        checkpointId,
        sessionId,
        projectId,
        projectPath
  ...
  async forkFromCheckpoint(
    ...
    try {
      return await invoke<CheckpointResult>("fork_from_checkpoint", {
        checkpointId,
        sessionId,
        projectId,
        projectPath,
  ...
  async getSessionTimeline(
    ...
    try {
      return await invoke<SessionTimeline>("get_session_timeline", {
        sessionId,
        projectId,
        projectPath
      });
  ...
  async updateCheckpointSettings(
    ...
    try {
      return await invoke<void>("update_checkpoint_settings", {
        sessionId,
        projectId,
        projectPath,
  ...
  async trackCheckpointMessage(
    ...
    try {
      return await invoke<void>("track_checkpoint_message", {
        sessionId,
        projectId,
        projectPath,
        message
  ...
  async clearCheckpointManager(sessionId: string): Promise<void> {
    try {
      return await invoke<void>("clear_checkpoint_manager", { sessionId });
    } catch (error) {
