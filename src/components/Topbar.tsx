    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="ml-0">{t('navigation.usage')}</span>
        </Button>
        ...
        >
          ...
          <span className="ml-0">CLAUDE.md</span>
        </Button>
        ...
        >
          ...
          <span className="ml-0">{t('navigation.mcpManager')}</span>
        </Button>
        ...
        >
          ...
          <span className="ml-0">{t('navigation.settings')}</span>
        </Button>
      </motion.div>
    </motion.div>
  );
